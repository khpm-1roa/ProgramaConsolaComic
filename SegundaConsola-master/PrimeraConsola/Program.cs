...
namespace PrimeraConsola
{
        class Program
    {
        static void Main(string[] args)
        {
            ...
            //todo :kevin metodo para poder validar que se ingrese un valor
           /* bool validarDatos(string datos)
            ...
            Console.WriteLine("*********************Bienvenido a WORDFREE *************************");
            Console.BackgroundColor = ConsoleColor.Black;
            //personaje favorito
            Console.BackgroundColor = ConsoleColor.Yellow;
            Console.WriteLine("Ingrese sus dattos para iniciar el juego ");
            Console.BackgroundColor = ConsoleColor.Black;
            Console.WriteLine(" ");
            ...
            Console.WriteLine(Personaje.Saludar());
            Console.WriteLine(Personaje.Caminar());
            Console.WriteLine(Personaje.Correr());
            Console.WriteLine(Personaje.Agacharse());
            Console.WriteLine(Personaje.Disparar());
            //clase vehiculo
            Console.BackgroundColor = ConsoleColor.Blue;
            Console.WriteLine("Ingrese los datos de su vehiculo favorito para inicar el juego ");
            Console.BackgroundColor = ConsoleColor.Black;
            Console.WriteLine(" ");
            ...
            //clase ropa
            Console.BackgroundColor = ConsoleColor.Red;
            Console.WriteLine("Ingrese los datos de su ropa favorita para el juego");
            Console.BackgroundColor = ConsoleColor.Black;
            Console.WriteLine(" ");
            ...
            //-------metodos de la ropa  --------
            Console.WriteLine(Ropa.Usar());
            Console.WriteLine(Ropa.Sacar());
            Console.WriteLine(Ropa.Modificar());
            Console.WriteLine(Ropa.Guardar());
            Console.WriteLine(Ropa.Regalar());
            ...
            Console.WriteLine(Armas.Obtener());
            Console.WriteLine(Armas.Usar());
            Console.WriteLine(Armas.Recargar());
            Console.WriteLine(Armas.Modificar());
            Console.WriteLine(Armas.Disparar());
            //clase mapa 
            Console.BackgroundColor = ConsoleColor.Blue;
            ...
            //-------metodos del mapa  --------
            Console.WriteLine(Mapa.Crear());
            Console.WriteLine(Mapa.Usar());
            Console.WriteLine(Mapa.Modificar());
            Console.WriteLine(Mapa.Eliminar());
            Console.WriteLine(Mapa.Actualizar());
